...
-- Implements Hybrid Analytics (Materialized View + Today's Live Data) for speed and accuracy.

-- 1. Revert has_role to SECURITY DEFINER
ALTER FUNCTION public.has_role(uuid, public.app_role) SECURITY DEFINER;

-- 2. Revert is_cafe_owner to SECURITY DEFINER
...
-- 5. Comprehensive Hybrid Analytics Function
...
DO $$ BEGIN RAISE NOTICE 'RE-10: Auth recursion fixed and hybrid analytics implemented.'; END $$;
